...
//   - Some have a separate API to list tags, while others return tags as part of the describe response.
//   - Even when the API model states that a Describe response will contain tags, the actual response may
//     not contain any tags. And users are expected to call a separate ListTags API to get the tags.
//
// - Noting a few different API names:
